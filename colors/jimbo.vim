...
" palette
let s:jimboFG=['#e4e4ef', '253']
let s:jimboFG1=['#f4f4ff', '254']
let s:jimboFG2=['#f5f5ff', '240']
let s:jimboFG3=['#65737e', '243']
let s:jimboWhite=['#ffffff', '15'] " done
let s:jimboBlack=['#000000', '0'] " done
let s:jimboBG=['#101010', '233'] " done
let s:jimboBG1=['#282828', '235'] " done
let s:jimboBG2=['#33242c', '238'] " done
let s:jimboBG3=['#453d41', '238'] " done
let s:jimboLightRed=['#c73c3f', '203']
let s:jimboRed=['#f43841', '160']
let s:jimboNiagara=['#839acc', '147'] " done
let s:jimboQuartz=['#7ab6e6', '108']
let s:jimboYellow=['#ffdd33', '108']
" let s:jimboGreen=['#02bf51', '70'] " can't decide
let s:jimboGreen=['#2ab863', '70'] " can't decide
" let s:jimboMain=['#ffdd33', '220']
" let s:jimboMain=['#c73c3f', '203']
let s:jimboMain=['#c94245', '203'] " done?
let s:jimboBrown=['#c9832e', '172'] " done
let s:jimboPurple=['#978ad1', '98'] " done
let s:jimboPink=['#d6bddb', '98'] " done
let s:jimboLightBlue=['#0087d7', '32']
let s:jimboBlue=['#0000d7', '20']
let s:jimboGold=['#d7af00', '178']
